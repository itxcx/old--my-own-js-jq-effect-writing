...
// 判断图片加载的函数
	...
	//pop
	var pop = $(".floatShowImagesWrap");
	//blackbg
	var bbg = $(".floatImagesBg");	
	li.click(function(){
		//异步加载		
		pop.html('<div class="floatShowImageTool w133"><span class="trans floatShow_prev"></span><span class="trans floatShow_next"></span><span class="trans floatShow_zoom sel"></span><span class="trans floatShow_close"></span></div><div class="floatShowImageContainer"><div class="floatShowImagebox"><p class="floatShowImage"><img src="images/photo/pic_01.jpg"></p></div><div class="floatShowImageinfo"><p class="fwinfo_title">阿昌姑娘</p><p class="fwinfo_size">80cm&nbsp; *&nbsp; 120cm</p><i></i><div class="clear"></div><p class="fwinfo_time">2012年作</p></div></div><span class="trans floatShowImagesclose"></span>');
  	bbg.show();
	pop.show();
	//判断图片已加载	
	isImgLoad(function(){
		//左箭头
		var leftA = $(".floatShow_prev");
		//右箭头
		var rightA = $(".floatShow_next");
		//放大
		var enlarge = $(".floatShow_zoom");
		//关闭
		var close = $(".floatShow_close");
		//大关闭
		var bigClose = $(".floatShowImagesclose");
		//info
		var info = $(".floatShowImageinfo");	
		//imageBox
		var imageBox = $(".floatShowImagebox");
		//pop
		var pop = $(".floatShowImagesWrap");				
		//img
		var img = $(".floatShowImage img");					
		//放大功能
		...
		$(window).resize(function(){
			...
			pop.css({"width":winWidth-40});
			imageBox.css({"width":winWidth-80});
			img.css({"max-width":winWidth-80,"max-height":"none","position":"static"});
		});
		//
			info.remove();
			bigClose.remove();
			imageBox.css({"border-right":"0"});			
			pop.css({"width":winWidth-40});
			imageBox.css({"width":winWidth-80});
			img.css({"max-width":winWidth-80,"max-height":"none","position":"static"});
		});
		close.add(bigClose).click(function(){
			pop.html("");
			pop.css({"width":"1191px"});
			bbg.add(pop).hide();
		})
	});
	})
